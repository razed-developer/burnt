...
Investigate appropriate open-source burning tools.

`cdrdao` should be evaluated because it supports Disk-At-Once Audio CD creation and CD-TEXT.

Other platform-specific or cross-platform alternatives may be considered if they provide better reliability.
